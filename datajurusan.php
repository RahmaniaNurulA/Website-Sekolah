            ...
            <div class="app-content">
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <button type="button" class="btn btn-success btn-tambah" id="btnTambahJurusan">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-primary btn-edit"
                                                        data-kode_jurusan="<?= $x['kode_jurusan']; ?>"
                                                        data-nama_jurusan="<?= htmlspecialchars($x['nama_jurusan'], ENT_QUOTES); ?>">
                                                        Edit
                                                    </button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="roll" name="roll" value="<?= ucfirst(htmlspecialchars($userRoll)) ?>" readonly />
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control font-monospace" value="<?= htmlspecialchars($passwordHash ?? 'N/A') ?>" readonly style="font-size: 12px;" />
        ...
        <form action="proses.php" method="post" id="formTambah">
            <div class="modal-content">
                <div class="modal-header bg-success text-white py-2">
                    <h6 class="modal-title mb-0"><i class="bi bi-person-plus"></i> Tambah Data Jurusan</h6>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body py-3">
                    <div class="row g-2">
                        <div class="col-6">
                            <label for="tambahJurusan" class="form-label mb-1 small">Nama Jurusan</label>
                            <input type="text" name="nama_jurusan" class="form-control form-control-sm" id="tambahJurusan" required>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form action="proses.php" method="post" id="formEdit">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" ><i class="bi bi-pencil-square"></i>Edit Data Jurusan</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body py-2">
                        <div class="mb-3">
                            <label for="displayEditKodeJurusan" class="form-label">Kode Jurusan</label>
                            <input type="text" class="form-control" id="displayEditKodeJurusan" readonly>
                        </div>
                        <input type="hidden" name="kode_jurusan" id="editKodeJurusan">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="editnama_jurusan" class="form-label">Nama Jurusan</label>
                                    <input type="text" name="nama_jurusan" class="form-control" id="editnama_jurusan" required>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <form action="proses.php" method="post" id="formHapus">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title"><i class="bi bi-trash"></i> Konfirmasi Hapus Data Jurusan</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus data jurusan <span id="hapusNamaJurusanSpan" class="fw-bold"></span> (<span id="displayHapusKodeJurusanSpan"></span>) ini?</p>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body p-3">
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            <small class="text-muted">Kode Jurusan</small>
                                            <input type="text" class="form-control form-control-sm" id="displayHapusKodeJurusanInput" readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <small class="text-muted">Nama Jurusan</small>
                                            <input type="text" class="form-control form-control-sm" id="hapusNamaJurusanInput" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <input type="hidden" name="kode_jurusan" id="hapusKodeJurusan">
                    <input type="hidden" name="nama_jurusan" id="hapusNamaJurusan">
...
<script>
    ...
    document.querySelectorAll('.btn-edit').forEach(btn => {
        btn.addEventListener('click', () => {
            document.getElementById('editKodeJurusan').value = btn.dataset.kode_jurusan;
            document.getElementById('displayEditKodeJurusan').value = btn.dataset.kode_jurusan;
            document.getElementById('editnama_jurusan').value = btn.dataset.nama_jurusan;
            modalEdit.show();
        });
    });

    // Event listener for Delete buttons - DIPERBAIKI
    document.querySelectorAll('.btn-delete').forEach(btn => {
        btn.addEventListener('click', () => {
            const kodeJurusan = btn.dataset.kode_jurusan;
            const namaJurusan = btn.dataset.nama_jurusan;
            
            // Isi hidden inputs untuk data yang akan dikirim ke server
            document.getElementById('hapusKodeJurusan').value = kodeJurusan;
            document.getElementById('hapusNamaJurusan').value = namaJurusan;
            
            // Isi display inputs untuk ditampilkan ke user
            document.getElementById('displayHapusKodeJurusanInput').value = kodeJurusan;
            document.getElementById('hapusNamaJurusanInput').value = namaJurusan;
            
            // Isi span untuk konfirmasi text
            document.getElementById('displayHapusKodeJurusanSpan').textContent = kodeJurusan;
            document.getElementById('hapusNamaJurusanSpan').textContent = namaJurusan;
